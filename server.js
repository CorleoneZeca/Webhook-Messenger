...
const PAGE_ACCESS_TOKEN = "EAACdEjZBujS4BAEZCqZBoQGsNHH7L9Yrc4QPBqb4XiJwjzZCPKH5kAVR2rYMbcsPETWaP31pjhFLHk2N4lDeb7r6WiPXxlgZAhu3omxeQZAnn3d1YctPE6axMG2bRMFqRFpKccrQ2TgaagBEWTqd1NIMeR4ybhADoTe0E7r7ti0AZDZD"
const SERVER_URL = "https://0389c322.ngrok.io";
...
app.get('/webhook', (req, res) => {
    ...
    const VERIFY_TOKEN = "PYyrMO0TpHEWU6guqVDkzs6gNoDQFRMH"
    ...
    if (received_message.text) {
        switch (received_message.text.replace(/[^\w\s]/gi, '').trim().toLowerCase()) {
            case "room preferences":
                console.log('room preferences log');
    ...
    let response = {
        attachment: {
            ...
            payload: {
                ...
                buttons: [{
                    type: "web_url",
                    url: "https://0389c322.ngrok.io/options.html",
